...
from divfree.tasks.stokes_homogeneous.runner import ExperimentRunner
...
def main() -> None:
    _enable_live_output()
    if len(sys.argv) < 2:
        print("Usage: python src/run_experiments_stokes.py <config.json> [mass_matrix=true|false]")
        sys.exit(1)
